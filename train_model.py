...
if __name__ == '__main__':
    ...
    #dataset parameters
    parser.add_argument('--training_predictors_path', type=str, default='/content/gdrive/MyDrive/project_folder/far/datasets/L3DAS21/processed/task2_predictors_train.pkl')
    parser.add_argument('--training_target_path', type=str, default='/content/gdrive/MyDrive/project_folder/far/datasets/L3DAS21/processed/task2_target_train.pkl')
    parser.add_argument('--validation_predictors_path', type=str, default='/content/gdrive/MyDrive/project_folder/far/datasets/L3DAS21/processed/task2_predictors_validation.pkl')
    parser.add_argument('--validation_target_path', type=str, default='/content/gdrive/MyDrive/project_folder/far/datasets/L3DAS21/processed/task2_target_validation.pkl')
    parser.add_argument('--test_predictors_path', type=str, default='/content/gdrive/MyDrive/project_folder/far/datasets/L3DAS21/processed/task2_predictors_test.pkl')
    parser.add_argument('--test_target_path', type=str, default='/content/gdrive/MyDrive/project_folder/far/datasets/L3DAS21/processed/task2_target_test.pkl')
    #training parameters
