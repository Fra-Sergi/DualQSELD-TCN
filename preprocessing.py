...
if __name__ == '__main__':
    ...
    parser.add_argument('--input_path', type=str, default='/content/gdrive/MyDrive/project_folder/var/datasets/L3DAS23/',
                        help='directory where the dataset has been downloaded')
    parser.add_argument('--output_path', type=str, default='/content/gdrive/MyDrive/project_folder/var/datasets/L3DAS23/processed',
